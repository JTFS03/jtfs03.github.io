...
document.addEventListener("DOMContentLoaded", function(){
  ...
  // Grab all elements we will interact with on the page from html
  ...
  function getWeather(location){
    ...
    // Show which location we are requesting (standard pullman, wa will be default)
